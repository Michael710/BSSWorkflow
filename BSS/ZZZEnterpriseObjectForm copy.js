...
function CreateWorkflow(){
   ...
   var URLString = 'BSSCreateWorkflow.php?ProcName=createadvworkflow&WorkflowId=' + varWorkflowId + "&MasterConfigName=" + BSSFormName + "&RecordId="  + varRecordId;
                alert(URLString);
    try{
        //Get the data
        xmlHttp = new XMLHttpRequest();
...
function GetWorkflows()
{
    ...
    try{
        ...
        xmlHttp = new XMLHttpRequest();
        varQueryId = 0;
        xmlHttp.open( "GET", "BSSGetJSData.php?BSSConfigName=" + "AdvWorkflowInstance" + "&BSSQueryId=" + "" + "&BSSWhereClause=" + "id>0 and masterid = " + varRecordId + " ORDER BY sequence,id DESC", false );
        xmlHttp.send( null );
    //    alert(xmlHttp.responseText);
        var newdata = eval('[' + xmlHttp.responseText + ']');
        workflowinstanceStore.loadData(newdata,false);
