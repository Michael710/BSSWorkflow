...
$SQL = "SELECT ldaphost,ldapdn,ldapusergroup,ldapmanagergroup,ldapuserdomain,emailhost,emailport,emailusername,emailpassword,NotificationTime,EscalationTime" . " FROM Setup;";
