...
var BSSChildConfigName = "UserRoles";
    ...
    var userstore = Ext.create('Ext.data.Store', {
        fields: [
            ...
            {name: 'EscalationUser', type: 'string'}
        ],
        data:
                   [['1','','','','','','','','']]
         });
    ...
    constructor: function(name) {
        ...
        usergrid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {
                    header: 'Escalation User',
                    width: 150,
                    dataIndex: 'EscalationUser',
                    editor:
                    { xtype: 'combobox',
                        typeAhead: true,
                        selectOnTab: true,
                        triggerAction: 'all',
                        fields:['id','value'],
                        store: BSSUserlistStore, //[[1, 'GLOBAL'],[2, 'USER']],
                        valueField:'id',
                        displayField:'value',
                        multiSelect: false,
                        queryMode: 'local',
                        lazyRender: false,
                        listClass: 'x-combo-list-small'},
                    renderer: function(val) {var matching =  BSSUserlistStore.queryBy( function(rec){ return rec.data.id == val; }); return (matching.items[0]) ? matching.items[0].data.value : ''}
            ...
            title: 'Users',
            frame: true,
            tbar: [{text: 'Add',    handler : function() {processInsert("Users",usergrid,userstore);}},
                   {text: 'Save',   handler : function() {processUpdate("Users",usergrid,userstore);}},
                  // {text: 'Inactivate', handler : function() {processDelete("Users",usergrid,userstore);}},
                   {text: 'Reset Password', handler : function() {processResetPassword("Users",usergrid,userstore);}}
            ],
